...
namespace 麥當勞訂購系統
{
    ...
    {
        List<string> list_Dessert_Name = new List<string>();
        List<int> list_Dessert_Price = new List<int>();
        ...
        private void Dessert_Load(object sender, EventArgs e)
        {
            ...
            GlobalVar.image_dir = @"C:\Users\iSpan\source\repos\元件開發\麥當勞訂購系統\麥當勞圖片\點心小品\"; // 照片來源路徑
            SQLLoading();
        ...
        void SQLLoading()
        {
            ...
            while (reader.Read() == true)
            {
                ...
                list_Dessert_Name.Add((string)reader["點心小品名稱"]);
                list_Dessert_Price.Add((int)reader["價格"]);
        ...
        private void Dessert_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void listCommodityView_ItemActivate(object sender, EventArgs e)
        {
            ...
            MyProductDetailsItems.OrderDessertID = (int)listCommodityView.SelectedItems[0].Tag;
