...
namespace 麥當勞訂購系統
{
    ...
    {
        List<string> list_Drink_Name = new List<string>();
        List<int> list_Drink_Price = new List<int>();
        ...
        private void Drink_Load(object sender, EventArgs e)
        {
            ...
            GlobalVar.image_dir = @"C:\Users\iSpan\source\repos\元件開發\麥當勞訂購系統\麥當勞圖片\飲料\"; // 照片來源路徑
            SQLLoading();
        ...
        void SQLLoading()
        {
            ...
            con.Open();
            string strSQL = "select * from Drink1;";
            ...
            while (reader.Read() == true)
            {
                ...
                list_Drink_Name.Add((string)reader["飲料名稱"]);
                list_Drink_Price.Add((int)reader["價格"]);
        ...
        private void Drink_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void listCommodityView_ItemActivate(object sender, EventArgs e)
        {
            ...
            MyProductDetailsItems.OrderDrinkID = (int)listCommodityView.SelectedItems[0].Tag;
